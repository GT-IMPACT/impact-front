...
export default {
  ...
  wiki_decs_0_0: 'This machine is designed for the production of charcoal / coke coal and creosote in the early stages.',
  ...
  wiki_decs_0_1: 'Designed to generate water at the initial stages and in hard-to-reach places without power supply.',
  ...
  wiki_decs_0_2: 'Designed for woodworking, since all other woodworking mechanics are disabled (except hand tools), you will need this machine for processing.',
  ...
  wiki_decs_0_3: 'The principle of operation of a pyrolysis oven is based on the thermal decomposition of organic substances into pyrolysis gases and solid residues.',
  ...
  wiki_decs_0_4: 'The principle of operation of a pyrolysis oven is based on the thermal decomposition of organic substances into pyrolysis gases and solid residues.',
  ...
  wiki_decs_0_5: 'Designed for pumping water from bedrock using electricity.',
  ...
  wiki_decs_0_6: 'The Space Satellite allows for wireless communication between machines on earth.',
  ...
  wiki_decs_0_7: 'The Communication Tower allows wireless communication between the satellite in orbit and machines on the «Earth».',
  ...
  wiki_decs_0_8: 'There are 3 tiers of the reactor, they differ in structure and the amount of rods (1, 9 or 25). ' +
  ...
  wiki_decs_0_9: 'The supercomputer allows parallels to be distributed to Impact machines.',
